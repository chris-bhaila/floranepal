                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        @if ($nursery->location)
                            <div class="flex items-center gap-1.5 mt-2">
                                <svg class="w-3.5 h-3.5 shrink-0" style="color: rgba(134,239,172,0.5);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col gap-2 shrink-0">
                        @if ($nursery->contact_phone)
                            <div class="flex items-center gap-2">
                                <svg class="w-3.5 h-3.5 shrink-0" style="color: rgba(134,239,172,0.4);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-center gap-2 mt-1">
                            <span class="inline-flex items-center gap-1 text-[10px] font-semibold tracking-wider uppercase px-2.5 py-1 rounded-full"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full {{ $nursery->is_active ? 'bg-green-400' : 'bg-red-400' }}"></span>
        ...
        <div class="px-4 md:px-8 pb-16 max-w-7xl mx-auto">
            ...
            @if ($nursery->plants->isEmpty())
                <div class="flex flex-col items-center justify-center py-24 gap-3">
                    <svg class="w-10 h-10" style="color: rgba(74,222,128,0.2);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @else
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5"
                    ...
                    @foreach ($nursery->plants as $plant)
                        <div class="flex flex-col p-3 transition-colors duration-200"
